<template>
  <Menu as="div" class="relative inline-block text-left">
    <div>
      ...
      >
        <span
          class="material-symbols-outlined text-violet-200 hover:text-violet-100"
          aria-hidden="true"
        >
          language
        </span>
    ...
    >
      <MenuItems
        class="absolute right-0 z-20 mt-2 w-28 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
      >
        <div class="px-1 py-1">
